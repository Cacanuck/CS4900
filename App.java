...
public class App extends Application {
    ...
    private void showColorPickerScene(String title, List<Color> colors) {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            colorButton.setStyle("-fx-pref-width: 50; -fx-pref-height: 50; -fx-min-width: 50; -fx-min-height: 50; -fx-max-width: 50; -fx-max-height: 50;");
    ...
    private void randomizeColors() {
        ...
        if (colorButtons != null) {
            ...
            for (int i = 0; i < colorButtons.size(); i++) {
                ...
                colorButton.setStyle("-fx-background-color: #" + toHexString(color) + "; -fx-pref-width: 50; -fx-pref-height: 50;");
